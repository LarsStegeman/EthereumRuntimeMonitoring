...
public class IdentifierChecker extends SolidityAnnotatedBaseVisitor<String>{
  

    ValidationInformation vi;
	private List<String> errors;

    public IdentifierChecker(ValidationInformation info){
        this.vi = info;
    ...
    public String visitAnnotationExpression(AnnotationExpressionContext ctx){
        ...
        if(ctx.primaryExpression() != null){
            ...
            if(ctx.booleanOp() != null){
                ...
                if(!type1.equals("uint256") || !type1.equals("uint256")){
